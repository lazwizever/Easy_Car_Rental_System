...
import {styleSheet} from "./adminProfileStyles";
            ...
            <Grid className={classes.container}>
                ...
                <Grid className={classes.leftGrid}>
                    ...
                    <Grid style={{display:'flex',justifyContent:'center',alignItems:'center',marginTop:'10vh'}}>
                        ...
                        <Button style={{backgroundColor:'#222f3e',color:'white',fontWeight:'semi',height:'6vh',width:'10vw',
...
export default withStyles(styleSheet)(AdminProfile)